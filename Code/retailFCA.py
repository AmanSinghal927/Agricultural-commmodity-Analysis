...
class FCA:
    def __init__(self):
        ...
        # Change Here
        self.start_date = self.string2date("01/01/2016")
        self.end_date = self.string2date("31/12/2017")


        self.url = "https://fcainfoweb.nic.in/reports/report_menu_web.aspx"
        #self.browser = webdriver.Chrome()
        self.browser = webdriver.Chrome(chrome_location, chrome_options=chrome_options)
